...
TITLE = """<h1 align="center">AI Shopping Agent 🛒</h1>"""
SUBTITLE = """<h2 align="center">Smart Search Using Gemnini</h2>"""
...
text_prompt_component = gr.Textbox(
    placeholder="Search... [press Enter]", show_label=False, autofocus=True, scale=8
)
